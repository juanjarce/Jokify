...
public class Store {
    ...
    private Store(String name) {
        ...
        artist1.getSongs().addFirst(song2);
        artist1.getSongs().addFirst(song3);
        ...
        artist2.getSongs().addFirst(song7);
        artist2.getSongs().addFirst(song8);
        artist2.getSongs().addFirst(song9);
        artist2.getSongs().addFirst(song10);
